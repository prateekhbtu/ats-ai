      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-2 md:grid-cols-6 gap-8 mb-16">
          ...
          <div className="col-span-2 md:col-span-2">
            <Link to="/" className="inline-flex items-center gap-2 mb-4">
              ...
              <span className="font-semibold text-lg tracking-tight">atsai</span>
            </Link>
            <p className="text-sm text-gray-400 leading-relaxed max-w-xs">
              AI-powered resume optimization that helps job seekers bypass
              automated filters and land more interviews.
            </p>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-sm text-gray-500">
            © {new Date().getFullYear()} atsai. All rights reserved.
          </p>
